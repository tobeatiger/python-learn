...
var parallel_1 = __webpack_require__(9);
...
var _pgListPage = __webpack_require__(34);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function init() {
  (0, _homePage.initHome)();
  (0, _pgListPage.initPgList)();
}
...
(0, _jquery.default)(document).ready(fireWhenReady);
...
function preFormat(code) {
  ...
  if (code) {
    ...
    for (var i = 0; i < code.length; i++) {
      var currLine = code[i];
      var nextLine = code[i + 1]; // 1. skip all empty lines if in indentation context
      ...
      if (/^\s/.test(currLine) // currLine is indented
...
function initHome() {
  ...
  socket.on('reply', function (msgs) {
    if (msgs) {
      ...
      _jquery.default.each(msgs, function (index, msg) {
        var li$ = (0, _jquery.default)('<li></li>').html(msg);

        if (msg.trim() == '>>>' || index == msgs.length - 1) {
          li$.append((0, _jquery.default)('<input type="text"/>').focus().keypress(function (e) {
            if (e.which == 13) {
              socket.emit('command', (0, _jquery.default)(this).val());

              if ((0, _jquery.default)(this).val().trim() !== hist[hist.length - 1]) {
                hist.push((0, _jquery.default)(this).val());
              }

              currHistIdx = hist.length;
              (0, _jquery.default)('#terminal').find('li input').each(function () {
                (0, _jquery.default)(this).after((0, _jquery.default)('<span></span>').html((0, _jquery.default)(this).val().replace(new RegExp(' ', 'g'), '&nbsp;').replace(new RegExp('>', 'g'), '&gt;').replace(new RegExp('<', 'g'), '&lt;'))).remove();
              });
            }
          }).keydown(function (e) {
            switch (e.which) {
              case 38:
                ...
                if (hist[currHistIdx]) {
                  (0, _jquery.default)(this).val(hist[currHistIdx]);
                }
        ...
        li$.appendTo((0, _jquery.default)('#terminal'));
      });

      (0, _jquery.default)('#terminal').find('li input').focus();
    } else {
      (0, _jquery.default)('#terminal').append('<li>Goodbye!</li>');
    }
  });
  var t$ = (0, _jquery.default)('#terminal');
  t$.on('click', function () {
    t$.find('li:last-child input').focus();
    setTimeout(function () {
      t$.animate({
        scrollTop: (0, _jquery.default)('#terminal').get(0).scrollHeight
      }, 300);
    }, 200);
  });
  (0, _jquery.default)('#btn_cls').on('click touchstart', function (e) {
    window._editor.setValue('', 1);

    e.preventDefault();
  });
  (0, _jquery.default)('#btn_run').on('click touchstart', function (e) {
    ...
    if (pg && pg.trim().length > 0) {
      ...
      if ((0, _jquery.default)(window).width() <= 720) {
        setTimeout(function () {
          (0, _jquery.default)('body').toggleClass('showProgram');
          (0, _jquery.default)('#terminal').click();
        }, 50);
      }
    }
  ...
  (0, _jquery.default)('#floating_btn').on('click touchstart', function (e) {
    (0, _jquery.default)('body').toggleClass('showProgram');
    e.preventDefault();
  });
  ...
  if ((0, _jquery.default)(window).width() <= 720) {
    ...
    (0, _jquery.default)('#btn_toggle_gutter').removeClass('on');
  ...
  (0, _jquery.default)('#btn_toggle_gutter').on('click touchstart', function (e) {
    (0, _jquery.default)(this).toggleClass('on');

    window._editor.renderer.setShowGutter((0, _jquery.default)(this).hasClass('on'));
...
exports.initPgList = initPgList;

var _jquery = _interopRequireDefault(__webpack_require__(7));

var _draggableButton = __webpack_require__(35);

var _popmotion = __webpack_require__(15);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var togglePGList = function togglePGList(pgList$, rel$, moveY) {
  if (!togglePGList._styler) {
    togglePGList._styler = (0, _popmotion.styler)(pgList$.get(0));
    togglePGList.__cutFrameCounter = 0;
    togglePGList.__cutFrame = false;
    togglePGList._action = (0, _popmotion.value)({}, function (v) {
  ...
  var fullScreenSet = {
    bottom: 0,
    right: 0,
    width: (0, _jquery.default)(window).width(),
    height: (0, _jquery.default)(window).height()
  };
  var relW = parseInt(rel$.css('width'), 10),
      relH = parseInt(rel$.css('height'), 10);
  var minScreenSet = {
  ...
  if (pgList$.hasClass('show')) {
    ...
    if (Math.min((0, _jquery.default)(window).width(), (0, _jquery.default)(window).height()) > 400) {
  ...
  (0, _jquery.default)(window).off('resize').on('resize', function () {
    if (pgList$.hasClass('show')) {
      togglePGList._styler.set({
        'width': (0, _jquery.default)(window).width() + 'px',
        'height': (0, _jquery.default)(window).height() + 'px'
      });
    }
  });
};
...
function initPgList() {
  var pgList$ = (0, _jquery.default)('body').find('.programList');
  var moveY = 0;
  var floatingBtn$ = (0, _draggableButton.draggableButton)({
    target: (0, _jquery.default)('#root'),
    ...
    dragging: function dragging(y) {
      moveY = y;
    }
  });
  pgList$.find('.nav-button').on('click touchstart', function (e) {
    (0, _jquery.default)(this).parent().toggleClass('hidden');
    e.preventDefault();
  });
  ...
  window._preview_editor.setOptions({
    scrollPastEnd: true,
    tabSize: 2,
    useSoftTabs: true
  });

  (0, _jquery.default)('#preview_editor').on('click touchstart', function (e) {
  ...
  pgList$.on('click touchstart', '.script-list > ul > li', function (e) {
    if (this === e.target) {
      // click on menu item
      (0, _jquery.default)(e.target).toggleClass('expanded');
    } else {
      (0, _jquery.default)('#pg-title').text('程序学习 - ' + (0, _jquery.default)(e.target).text());

      _jquery.default.ajax({
        url: './programs/' + (0, _jquery.default)(e.target).data('pg')
      }).done(function (pg) {
        window._preview_editor.setValue(pg, -1);

        (0, _jquery.default)('.script-list').addClass('hidden');
      });
    }

    e.preventDefault();
  });
  (0, _jquery.default)('#btn_preview_select').on('click touchstart', function (e) {
...
function draggableButton(params) {
  var _settings = _jquery.default.extend(true, {
    target: (0, _jquery.default)('body'),
    btnName: '',
    icon: 'icon-more',
    bottom: 90,
    onClick: function onClick() {
  ...
  if (!btn$.get(0)) {
    btn$ = (0, _jquery.default)('<div class="draggable-btn icon"></div>').prependTo(_settings.target);
  }

  btn$.css('bottom', _settings.bottom + 'px'); // switchIcon API
  ...
  var btn = btn$.get(0);
  var divStyler = (0, _popmotion.styler)(btn);
  var btnXY = (0, _popmotion.value)({
    x: 0,
    y: 0
  }, function (xy) {
    if (xy.y > 0) {
  ...
  (0, _popmotion.listen)(btn, 'mousedown touchstart').start(function (e) {
    e.preventDefault();
    btn._startDragXY = btnXY.get();
    (0, _popmotion.pointer)(btnXY.get()).start(btnXY);
  });
  (0, _popmotion.listen)(document, 'mouseup touchend').start(function () {
    btnXY.stop();
  });
  (0, _popmotion.listen)(btn, 'mouseup touchend').start(function () {
    var currentXY = btnXY.get();
