...
var _pgListPage = __webpack_require__(33);
...
var _draggableButton = __webpack_require__(34);
...
function initPgList() {
  ...
  var floatingBtn$ = (0, _draggableButton.draggableButton)({
    ...
    onClick: function onClick() {
      ...
      pgList$.one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function () {
      ...
      if (pgList$.hasClass('show')) {
        pgList$.css('bottom', '0').css('right', '0'); //pgList$.find('.content').show();
      } else {
        pgList$.css('bottom', parseInt(floatingBtn$[0].style.bottom) + 18).css('right', parseInt(floatingBtn$.css('right')) + 15); //pgList$.find('.content').hide();
      }

      (0, _jquery.default)(this).toggleClass('icon-more').toggleClass('icon-close');
    },
    dragEnded: function dragEnded(bottom) {
      if (!pgList$.hasClass('show')) {
        (0, _jquery.default)('body').find('.programList').css('bottom', parseInt(bottom) + 18).css('right', parseInt(floatingBtn$.css('right')) + 15);
      }
    }
  });
...
var _popmotion = __webpack_require__(35);
